...
#Region "DisplayResults"
    ...
    Private Sub DisplayResult()
        ...
        If GridView.GetFocusedRowCellValue(GridView.Columns("Status")).ToString = "For Verification" Then
            frmHemaNew.btnVerification.Caption = "Verify"
        End If
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaNew.txtEmail.Text = reader(0).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
    ...
    Private Sub DisplayResultCompleted()
        ...
        frmHemaOrdered.tmTimeReceived.Text = GridCompleted.GetFocusedRowCellValue(GridCompleted.Columns("TimeReceived")).ToString
