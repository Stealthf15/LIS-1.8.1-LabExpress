...
#Region "DisplayResults"
    ...
    Private Sub DisplayResult()
        ...
        If GridView.GetFocusedRowCellValue(GridView.Columns("Status")).ToString = "For Verification" Then
            frmUrinNew.btnVerification.Caption = "Verify"
        End If
        ...
        reader.Read()
        If reader.HasRows Then
            frmUrinNew.txtEmail.Text = reader(0).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
    ...
    Private Sub DisplayResultCompleted()
        ...
        frmUrinOrdered.dtReceived.Text = GridCompleted.GetFocusedRowCellValue(GridCompleted.Columns("DateReceived")).ToString
        frmUrinOrdered.tmTimeReceived.Text = GridCompleted.GetFocusedRowCellValue(GridCompleted.Columns("TimeReceived")).ToString
