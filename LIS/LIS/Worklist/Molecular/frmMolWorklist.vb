    ...
    Private Sub DisplayResult()
        ...
        For Each rowHandle As Integer In selectedRows
            If rowHandle >= 0 Then
                ...
                frmMolNew.mainID = GridView.GetRowCellValue(rowHandle, GridView.Columns("RefID"))
                frmMolNew.Section = GridView.GetRowCellValue(rowHandle, GridView.Columns("Section"))
                frmMolNew.SubSection = GridView.GetRowCellValue(rowHandle, GridView.Columns("SubSection"))
                frmMolNew.PatientID = GridView.GetRowCellValue(rowHandle, GridView.Columns("PatientID"))
                frmMolNew.txtSampleID.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("SampleID"))
                frmMolNew.txtPatientID.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("PatientID"))
                frmMolNew.txtName.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("PatientName"))
                frmMolNew.cboRequest.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("Request"))
                frmMolNew.dtReceived.Value = GridView.GetRowCellValue(rowHandle, GridView.Columns("DateReceived"))
                frmMolNew.tmTimeReceived.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("TimeReceived"))
                frmMolNew.cboSex.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("Sex"))
                frmMolNew.dtBDate.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("DateOfBirth"))
                frmMolNew.cboPatientType.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("PatientType"))
                frmMolNew.cboPhysician.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("Physician"))
                frmMolNew.cboRoom.Text = GridView.GetRowCellValue(rowHandle, GridView.Columns("RoomWard"))
                ...
                reader.Read()
                If reader.HasRows Then
                    frmMolNew.txtEmail.Text = reader(0).ToString
                End If
                Disconnect()
                '######################################----END-----###############################################################
    ...
    Private Sub DisplayResultCompleted()
        ...
        For Each rowHandle As Integer In selectedRows
            If rowHandle >= 0 Then
                ...
                '###########################---Load Basic Patient Details---######################################################
                frmMolOrdered.mainID = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("RefID"))
                frmMolOrdered.Section = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("Section"))
                frmMolOrdered.SubSection = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("SubSection"))
                frmMolOrdered.PatientID = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("PatientID"))
                frmMolOrdered.txtSampleID.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("SampleID"))
                frmMolOrdered.txtPatientID.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("PatientID"))
                frmMolOrdered.txtName.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("PatientName"))
                frmMolOrdered.cboRequest.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("Request"))
                frmMolOrdered.dtReceived.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("DateReceived"))
                frmMolOrdered.tmTimeReceived.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("TimeReceived"))
                frmMolOrdered.tmTimeReleased.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("DateReleased"))
                frmMolOrdered.cboSex.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("Sex"))
                frmMolOrdered.dtBDate.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("DateOfBirth"))
                frmMolOrdered.cboPatientType.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("PatientType"))
                frmMolOrdered.cboPhysician.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("Physician"))
                frmMolOrdered.cboRoom.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("RoomWard"))
                frmMolOrdered.cboMedTech.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("PerformedBy"))
                frmMolOrdered.cboVerify.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("ReleasedBy"))
                frmMolOrdered.cboPhysician.Text = GridCompleted.GetRowCellValue(rowHandle, GridCompleted.Columns("Physician"))
