    ...
    Private Sub btnAddTest_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnAddTest.ItemClick
        If TypeResult = "New" Then
            For x = Me.lvList.CheckedItems.Count - 1 To 0 Step -1
                ...
                rs.Parameters.AddWithValue("@his_testcode", lvList.CheckedItems(x).SubItems(5).Text)
                ...
                rs.Parameters.AddWithValue("@order_no", lvList.CheckedItems(x).SubItems(11).Text)
                rs.Parameters.AddWithValue("@test_group", lvList.CheckedItems(x).SubItems(12).Text)
        ...
        ElseIf TypeResult = "Old" Then
            For x = Me.lvList.CheckedItems.Count - 1 To 0 Step -1
                ...
                SaveRecordwthoutMSG("INSERT INTO `result` (`universal_id`, `measurement`,`test_code`, `sample_id`, `date`, `patient_id`, `order_no`, `test_group`, `units`, `unit_conv`, `instrument`, `his_code`, `section`, `sub_section`) VALUES " _
                            & "(" _
                            & "@UniversalID, @Measurement, @test_code, @sample_id, @date, @patient_id, @order_no, @test_group, @si_unit, @conv_unit, 'Other_Test', @his_testcode, @section, @SubSection" _
                            & ")"
                            )
